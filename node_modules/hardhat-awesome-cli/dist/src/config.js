...
exports.getAddressBookConfig = exports.addressBookDefaultConfig = exports.DefaultGithubWorkflowsList = exports.DefaultGithubWorkflowsGroup = exports.DefaultFoundryTestUtilsList = exports.DefaultHardhatPluginsList = exports.DefaultChainList = exports.fileEnvHardhatAwesomeCLI = exports.fileHardhatAwesomeCLI = void 0;
exports.fileHardhatAwesomeCLI = 'hardhat-awesome-cli.json';
exports.fileEnvHardhatAwesomeCLI = '.env.hardhat-awesome-cli';
exports.DefaultChainList = [
    {
...
exports.DefaultHardhatPluginsList = [
    {
...
exports.DefaultFoundryTestUtilsList = [
...
exports.DefaultGithubWorkflowsGroup = ['npm', 'yarn'];
exports.DefaultGithubWorkflowsList = [
    {
...
exports.addressBookDefaultConfig = {
    savePath: './',
...
const getAddressBookConfig = (userConfig = {
    addressBook: exports.addressBookDefaultConfig
}) => {
    if (userConfig.addressBook)
        return {
            savePath: userConfig.addressBook.savePath || exports.addressBookDefaultConfig.savePath,
            openzeppelinPath: userConfig.addressBook.openzeppelinPath || exports.addressBookDefaultConfig.openzeppelinPath,
            contractsFlattenPath: userConfig.addressBook.contractsFlattenPath || exports.addressBookDefaultConfig.contractsFlattenPath,
            contractsFlattenPrefix: userConfig.addressBook.contractsFlattenPrefix || exports.addressBookDefaultConfig.contractsFlattenPrefix,
            fileHardhatAwesomeCLI: userConfig.addressBook.fileHardhatAwesomeCLI || exports.addressBookDefaultConfig.fileHardhatAwesomeCLI,
            fileEnvHardhatAwesomeCLI: userConfig.addressBook.fileEnvHardhatAwesomeCLI || exports.addressBookDefaultConfig.fileEnvHardhatAwesomeCLI,
            fileContractsAddressDeployed: userConfig.addressBook.fileContractsAddressDeployed ||
                exports.addressBookDefaultConfig.fileContractsAddressDeployed,
            fileContractsAddressDeployedHistory: userConfig.addressBook.fileContractsAddressDeployedHistory ||
                exports.addressBookDefaultConfig.fileContractsAddressDeployedHistory
        };
    return exports.addressBookDefaultConfig;
};
exports.getAddressBookConfig = getAddressBookConfig;
