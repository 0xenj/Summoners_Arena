...
contract Signatures is DSTest {
    ...
    function signature_signHashEip191(bytes32 hash_) internal pure virtual returns (bytes32) {
        return keccak256(abi.encodePacked('\x19Ethereum Signed Message:\n32', hash_));
    }

    function signature_signHashEip712(bytes32 domainSeparator_, bytes32 hash_) internal pure virtual returns (bytes32) {
    ...
    function test_coverageIgnore_Signatures() internal pure {}
}
